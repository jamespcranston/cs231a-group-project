# Takes 2 rectified images of the same dimension, and performs sliding-window
# correspondence algorithm for disparity mapping. Uses normalized cross-
# correlation and dual-aggregation harmonic mean to combine the colorbar
# channels. Also takes a window diameter and threshold level between 0 and 1
# representing stringency of correspondence points. 0 includes everything
# and 1 accepts only perfect matches. 
